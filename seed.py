...
def sla_user_role():
    db.session.add(SlaUserRole(user_id="admin",account='maxico',role='admin'))


def seed_sla_data():
    db.session.add(SlaDataModel(account='maxico',application="python",sla_date=date.today(),sla_number=12,sla_type='09_AM',total_reqeust=2000,within_sla_reqeust=1600,sla_percentage=70,sla_met=True))
