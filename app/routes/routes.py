from app import api
from app.views.views import VistaLoginView, VistaHomeView, ContactView, AccountSlaView, ServiceView, \
    SlaDownloadView, RequestsView, AccessControlView, SlaDashboardView, SignUpView, ResetPasswordView, PasswordChange
...
api.add_resource(VistaHomeView, '/api/home/<string:user>/<string:account>')
api.add_resource(RequestsView, '/api/raise_requests')
api.add_resource(SignUpView, '/api/signup')
api.add_resource(PasswordChange, '/api/change_password')
api.add_resource(ResetPasswordView, '/api/reset_password')
